...
require (
	...
	github.com/nodeset-org/hyperdrive-daemon v1.0.2-0.20240719155648-2448ebce53b8
...
require (
	...
	github.com/nodeset-org/nodeset-client-go v0.0.0-20240719155611-d9ac5c5e15d7 // indirect
