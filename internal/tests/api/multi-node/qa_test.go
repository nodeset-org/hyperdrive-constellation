...
func TestComplexRoundTrip(t *testing.T) {
	...
	nodes := []*cstesting.ConstellationNode{mainNode, node2, node3, node4, node5}
	...
	// Stake the minipools
	nodeAddresses := []common.Address{mainNodeAddress, node2Address, node3Address, node4Address, node5Address}
	for i, mp := range mps {
