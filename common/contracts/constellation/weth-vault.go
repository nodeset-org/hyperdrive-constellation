...
func (c *WethVault) GetLiquidityReservePercent(mc *batch.MultiCaller, out **big.Int) {
	eth.AddCallToMulticaller(mc, c.contract, out, "liquidityReservePercent")
}

func (c *WethVault) GetWethBalance(mc *batch.MultiCaller, out **big.Int) {
	eth.AddCallToMulticaller(mc, c.contract, out, "balanceWeth")
}

func (c *WethVault) GetTvlRatioEthRpl(mc *batch.MultiCaller, out **big.Int, newDeposit *big.Int, isWeth bool) {
...
func (c *WethVault) SetMaxWethRplRatio(ratio *big.Int, opts *bind.TransactOpts) (*eth.TransactionInfo, error) {
	return c.txMgr.CreateTransactionInfo(c.contract, "setMaxWethRplRatio", opts, ratio)
}

func (c *WethVault) SetLiquidityReservePercent(newPercent *big.Int, opts *bind.TransactOpts) (*eth.TransactionInfo, error) {
	return c.txMgr.CreateTransactionInfo(c.contract, "setLiquidityReservePercent", opts, newPercent)
}

func (c *WethVault) SetTreasuryFee(percentFee *big.Int, opts *bind.TransactOpts) (*eth.TransactionInfo, error) {
	return c.txMgr.CreateTransactionInfo(c.contract, "setTreasuryFee", opts, percentFee)
}

func (c *WethVault) SetNodeOperatorFee(percentFee *big.Int, opts *bind.TransactOpts) (*eth.TransactionInfo, error) {
	return c.txMgr.CreateTransactionInfo(c.contract, "setNodeOperatorFee", opts, percentFee)
}
