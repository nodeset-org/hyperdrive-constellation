...
func (c *RplVault) GetLiquidityReservePercent(mc *batch.MultiCaller, out **big.Int) {
...
func (c *RplVault) SetLiquidityReservePercent(newPercent *big.Int, opts *bind.TransactOpts) (*eth.TransactionInfo, error) {
