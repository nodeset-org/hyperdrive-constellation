...
func (c *RplVault) SetMinWethRplRatio(ratio *big.Int, opts *bind.TransactOpts) (*eth.TransactionInfo, error) {
	return c.txMgr.CreateTransactionInfo(c.contract, "setWETHCoverageRatio", opts, ratio)
}
