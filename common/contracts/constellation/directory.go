...
func (c *Directory) GetAssetRouterAddress(mc *batch.MultiCaller, out *common.Address) {
	eth.AddCallToMulticaller(mc, c.contract, out, "getAssetRouterAddress")
}

func (c *Directory) GetXrEthAdminOracleAddress(mc *batch.MultiCaller, out *common.Address) {
	eth.AddCallToMulticaller(mc, c.contract, out, "getRETHOracleAddress")
}
