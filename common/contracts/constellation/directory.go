...
func (c *Directory) GetNodeSetOperatorRewardsDistributorAddress(mc *batch.MultiCaller, out *common.Address) {
	eth.AddCallToMulticaller(mc, c.contract, out, "getNodeSetOperatorRewardDistributorAddress")
}
